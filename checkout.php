<?php
// بداية buffer الإخراج
ob_start();

// يجب أن تكون الجلسة في البداية
session_start();

include("./include/connection.php");

// أي عمليات تحتاج إلى header() يجب أن تكون هنا
...
// عرض الصورة مع التحقق من وجودها
echo '<img src="'.$image_path.'" width="50" 
...
<?php
// نهاية buffer الإخراج وإرسال المحتوى
ob_end_flush();
?>